...
- 首帧 Prompt 会要求背影或脸外构图，以降低 Seedance 人像隐私拒绝概率；这只是提示词层面的尽力约束，当前没有生成后人脸检测，不能保证每次产物或供应商审核结果。
...
- 方舟可信真人/虚拟人 `asset://...` 资产输入链路尚未实现；如需可识别固定演员，需先确认授权范围，再新增可信资产字段、校验和 Provider 参数映射；
